...
### Requirement: Chinese locale support
**Reason**: No Chinese-speaking user base exists. Maintaining dual-language support adds unnecessary complexity to development and testing.
**Migration**: All Chinese locale files (`locales/zh.json`, `app_localizations_zh.dart`, `app_zh.arb`) are deleted. Users see English text automatically — no user action required.
